...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2017 at 03:01 PM
...
(1, 'Vostok-K | Vostok 1', '19610412T060700Z', '19610412T060700Z', 3, 163, 29, 139),
(2, 'Vostok-K | Vostok 2', '19610806T060000Z', '19610806T060000Z', 3, 163, 29, 139),
(3, 'Atlas LV-3B | Mercury-Atlas 6', '19620220T144739Z', '19620220T144739Z', 3, 161, 70, 140),
(4, 'Atlas LV-3B | Mercury-Atlas 7', '19620524T124516Z', '19620524T124516Z', 3, 161, 70, 140),
(5, 'Vostok-K | Vostok 3', '19620811T082400Z', '19620811T082400Z', 3, 163, 29, 139),
(6, 'Vostok-K | Vostok 4', '19620812T080233Z', '19620812T080233Z', 3, 163, 29, 139),
(7, 'Atlas LV-3B | Mercury-Atlas 8', '19621003T121512Z', '19621003T121512Z', 3, 161, 70, 140),
(8, 'Atlas LV-3B | Mercury-Atlas 9', '19630515T130413Z', '19630515T130413Z', 3, 161, 70, 140),
(9, 'Vostok-K | Vostok 5', '19630614T115858Z', '19630614T115858Z', 3, 163, 29, 139),
(10, 'Vostok-K | Vostok 6', '19630616T092952Z', '19630616T092952Z', 3, 163, 29, 139);
...
(1, 'Nuclear Spectroscopic Telescope Array (NuSTAR)', 'Designed to image high-energy X-ray radiation, the Nuclear Spectroscopic Telescope Array (NuSTAR) is tasked with surveying regions surrounding the center of own Milky Way Galaxy and performing deep observations of the extragalactic sky, studying black holes and supernovas.', 44),
(2, 'WGS-4 (USA-233)', 'The United Launch Alliance Delta 4 rocket launched the fourth Wideband Global SATCOM spacecraft, formerly known as the Wideband Gapfiller Satellite. Built by Boeing, this geostationary communications spacecraft serves U.S. military forces.', 124),
(3, 'SES-4', 'An International Launch Services Proton rocket with a Breeze M upper stage will deploy the SES 4 satellite to provide telecommunications services over the Americas, Africa, Europe and the Middle East. ', 118),
(4, 'Dragon C2', 'SpaceX COTS Demo Flight 2', 0),
(5, 'SpX CRS-1', 'This was the third flight for the uncrewed Dragon cargo spacecaft and the first SpaceX mission under their Commercial Resupply Services contract with NASA. Dragon delivered various cargo to the staion, and returned after being berthed to the station for 17 days. The spacecraft landed in the Pacific Ocean and was recovered by SpaceX.', 44),
(6, 'TDRS-K', 'TDRS-11, known before launch as TDRS-K, is an American communications satellite which is operated by NASA as part of the Tracking and Data Relay Satellite System, which provides a multitude of communications services to a wide variety of missions.', 44),
...
(8, 'SARAL', 'SARAL or Satellite with ARgos and ALtiKa is a cooperative altimetry technology mission of Indian Space Research Organisation (ISRO) and CNES (Space Agency of France). SARAL is tasked to perform altimetric measurements designed to study ocean circulation and sea surface elevation.', 31),
...
(11, 'Eutelsat 115 West B & ABS-3A', 'These are both geostationary communication satellites, with Eutelsat 155 West B providing coverage in the Americas, and ABS-3A providing coverage in the Americas, the Middle East, and Africa.', 121),
...
(13, 'Resurs-P No.1', 'Resurs-P No.1 is a Russian commercial earth observation satellite capable of acquiring high-resolution imagery (resolution up to 1.0 m).', 63),
(14, 'CBERS-3', 'This remote sensing satellite was intended for China-Brazil program on Environment, Agriculture, and Urban Planning.', 17),
(15, 'SBIRS GEO-2 (USA-241) (SBIRS GEO Flight 2)', 'This geostationary satellite is tasked with providing capabilities for early missile warning and missile defense.', 161),
(16, 'Vostok 1', 'The first crewed space launch & the first orbital launch. It carried the Soviet cosmonaut Yuri Gagarin who completed 1 orbit before safely re-entering the atmosphere, he ejected from his capsule at an altitude of 7 km in order to parachute safely to the ground. The mission lasted 108 minutes.', 6),
(17, 'GSAT-14', 'GSAT-14 is an Indian communications satellite, which replaced the GSAT-3 satellite. With a mass of 1982 kg, GSAT-14 is expected to operate in orbit for 12 years.', 31),
(18, 'Swarm A, B, C', 'European Space Agency\'s mission Swarm consists of 3 satellites tasked with studying Earth\'s magnetic field.', 117),
...
(21, 'Progress M-19M (51P)', 'The Progress resupply vehicle is an automated, unpiloted version of the Soyuz spacecraft that is used to bring supplies and fuel to the International Space Station.', 63),
(22, 'Resourcesat-2A', 'Resourcesat-2A is a remote sensing satellite, third in the program of the same name. It is intended to provide data continuity for users as a follow on mission to Resourcesat-2.', 31),
(23, 'CASSIOPE', 'CASSIOPE (Cascade SmallSat and Ionospheric Polar Explorer) is a small satellite mission for Canadian Space Agency to feature the first in a new generation of multi-purpose satellite platforms. It is tasked with a dual mission on scientific research and telecommunications.', 16),
(24, 'Interface Region Imaging Spectrograph (IRIS)', 'The Interface Region Imaging Spectrograph (IRIS) is a NASA Small Explorer Mission to observe how solar material moves, gathers energy, and heats up as it travels through a little-understood region in the sun\'s lower atmosphere.', 44),
(25, 'O3b FM1, FM2, FM4, FM5', 'The O3b Satellite Constellation is a satellite constellation designed for telecommunications and data backhaul from remote locations.', 115),
...
(1, 'Launch Area 5B, Woomera', '-30.971993000000000', '136.475005000000000', 160, 20),
(2, 'Launch Area 6A, Woomera', '-31.074000000000000', '136.439400000000000', 160, 20),
(3, 'Launch Area 6B, Woomera', '-31.079200000000000', '136.445000000000000', 160, 20),
(4, 'Launch Area 8, Woomera', '-31.034000000000000', '136.463000000000000', 160, 20),
(5, 'Launch Area 2A, Jiuquan', '41.306000000000000', '100.314000000000000', 162, 1),
(6, 'Launch Area 2B, Jiuquan', '41.309000000000000', '100.317000000000000', 162, 1),
(7, 'Launch Area 4 (SLS-2 / 603), Jiuquan', '40.960556000000000', '100.298333000000000', 17, 1),
(8, 'Launch Area 4 (SLS-1 / 921), Jiuquan', '40.958093000000000', '100.291188000000000', 17, 1),
(9, 'Edwards Air Force Base', '34.905556000000000', '-117.883611000000000', 100, 39),
(10, 'Rocket Lab Launch Site', '-39.262833000000000', '177.864469000000000', 147, 40),
(11, 'Launch Area 3(Launch Area 2 Rebuilt 2006), Jiuquan', '0.000000000000000', '0.000000000000000', 162, 1),
(12, 'Launch Area 4?, Jiuquan', '28.249500000000000', '102.023200000000000', 162, 1),
(13, 'Launch Area 1, Taiyuan', '38.849000000000000', '111.608000000000000', 162, 2),
(14, 'Launch Area 2, Taiyuan', '38.863428000000000', '111.589004000000000', 162, 2),
(15, 'Ariane Launch Area 3, Kourou', '5.239000000000000', '-52.768000000000000', 115, 3),
(16, 'Yoshinobu Launch Complex, Tanegashima, Japan', '30.399000000000000', '130.970000000000000', 37, 9),
(17, 'Ariane Launch Area, Kourou', '5.207642000000000', '-52.772384000000000', 115, 3),
(18, 'Ariane Launch Area 1, Kourou', '5.236000000000000', '-52.775000000000000', 115, 3),
(19, 'Brigitte Pad, Hammaguir', '30.871000000000000', '-3.008000000000000', 0, 4),
(20, 'PSLV Pad (PSLV, GSLV), Sriharikota', '13.733000000000000', '80.235000000000000', 31, 5),
(21, 'SLP, Sriharikota', '13.720000000000000', '80.230000000000000', 31, 5),
(22, 'Safir Pad, Iran', '35.234000000000000', '53.921000000000000', 34, 6),
(23, 'Unknown New Larger Pad, Iran', '35.238000000000000', '53.951000000000000', 34, 6),
(24, 'San Marco Platform, Kenya', '', '', 36, 7),
(25, 'M5 Pad, Kagoshima', '31.251000000000000', '131.082000000000000', 37, 8),
(26, 'Mu Pad, Kagoshima', '31.252000000000000', '131.079000000000000', 37, 8),
(27, 'Osaki Y LP1, Tanegashima, Japan', '30.401000000000000', '130.977000000000000', 37, 9),
(28, 'Osaki Y LP2, Tanegashima, Japan', '30.401000000000000', '130.975000000000000', 37, 9),
(29, '1/5, Baikonur Cosmodrome, Kazakhstan', '45.920000000000000', '63.342000000000000', 163, 10),
(30, '31/6, Baikonur Cosmodrome, Kazakhstan', '45.996034000000000', '63.564003000000000', 163, 10);
